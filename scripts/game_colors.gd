...
# Assembly (forward progress) - Green
const COLOR_ASSEMBLE := Color(0.3, 1.0, 0.4, 1.0)

# Disassembly (go back) - Red  
const COLOR_DISASSEMBLE := Color(1.0, 0.4, 0.3, 1.0)
...
const OUTLINE_ASSEMBLE := Color(0.3, 1.0, 0.4, 0.25)
const OUTLINE_DISASSEMBLE := Color(1.0, 0.4, 0.3, 0.25)
